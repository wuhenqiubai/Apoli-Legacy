...
public class UpgradeUtils {
    ...
    public static JsonObject upgradeRecipe(JsonObject dynamic) {
        if (dynamic.has("ingredients")) {
            var ingredients = dynamic.get("ingredients");
            ...
            if (ingredients.isJsonArray()) {
                ...
                dynamic.remove("ingredients");
                dynamic.add("ingredients", newArray);
            }
        }

        if (dynamic.has("result") && dynamic.get("result").isJsonObject()) {
            var result = dynamic.getAsJsonObject("result");
